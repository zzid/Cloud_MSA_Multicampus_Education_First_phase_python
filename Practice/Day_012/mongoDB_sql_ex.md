...
db.employees.find(
    { hire_date : {$gt : ISODate('2017-01-01')} }
)
//9.select number,last_name,first_name from employees
db.employees.find(
    {},
    {number : 1, last_name : 1, first_name : 1, _id : 0 }
)
...
db.employees.count()
//22.db.employees.find().count() 안됨

//23.insertOne
//insert into employees
//(number,last_name,first_name,salary,department,status)
...
//update() operation
//uses the $unset operator to remove the fields status and salary
